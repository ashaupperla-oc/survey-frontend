<template>
  <section class="vh-100">
    ...
    <b-alert show variant="success" v-if="$route.params.id === 'registered'"
      >User Registered Successfully</b-alert
    >
      ...
      >
        ...
        <div>
          <form>
            ...
            <div class="form-outline mb-3">
              <label for="confirmpassword" style="margin: 1vh"
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(
        import.meta.env.VITE_SERVER_ENDPOINT + "api/admin/" + adminId,
        config
      )
      .then((res) => {
  ...
  methods: {
    updateAdminDetail() {
      ...
      axios
        .put(
          import.meta.env.VITE_SERVER_ENDPOINT + "api/admin/update",
          updatedAdminDetails,
          config
        )
        .then((res) => {
    ...
    updatePasswordDetails() {
      if (
        ...
        this.$router.push({
          name: "GetMySurvey",
          params: { id: "IncorrectPasswordDetails" },
        });
        return;
      } else {
        ...
        axios
          .put(
            import.meta.env.VITE_SERVER_ENDPOINT + "api/admin/updatepassword",
          ...
          .then((res) => {
            if (res.status == 401) {
              ...
              this.$router.push({
                name: "GetMySurvey",
                params: { id: "passwordupdatesuccess" },
              });
            }
          });
      }
