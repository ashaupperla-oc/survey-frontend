<template>
  <div class="vue-survey-builder-content vsb-content container-fluid">
    ...
    <div class="question-section" v-if="selectedType !== 'DEFAULT'">
      ...
      <div class="" v-if="selectedType === 'BOOLEAN'">
        ...
        <div class="" v-for="(option, index) in question.options" :key="index">
          <div class="clear-both">
            <input type="text" class="width-100 float-left" placeholder="Enter an answer choice" v-model="option.body" required>
      ...
      <div class="scale-type" v-if="selectedType === 'SCALE'">
        <div class="">
          <div class="display-inline-block" style="margin:1vh">Number Of Stars : </div>
...
export default {
  ...
  methods: {
    ...
    saveQuestion(question) {
      ...
      this.emitter.emit('add-update-question', question);
